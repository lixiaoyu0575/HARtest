...
# dataset = read_data('./data/actitracker_checked.txt')
# dataset = read_data('./data/actitracker_new.txt')
dataset = read_data('./data/actitracker_100000.txt')
...
processedData = open('./data/processed_WISDM_HAR_100000_notNormalized.pkl', 'wb')
