...
def ResNet_model(WINDOW_SIZE):
    ...
    input1 = Input(shape=(128, 9), name='input')
...
def model_eval(X, y, Xval, yval):
    ...
    for r in range(rep):
        ...
        for k in range(Kfold):
            ...
            callbacks = [
                ...
                # Saving best model
                ModelCheckpoint('testHAR-filters{}-poolingstr{}_resnet-filters{}-ksize{}-poolingstr{}-loopnum{}.hdf5'
            ...
            model.load_weights('testHAR-filters{}-poolingstr{}_resnet-filters{}-ksize{}-poolingstr{}-loopnum{}.hdf5'
    ...
    scipy.io.savemat('xval_testHAR-filters{}-poolingstr{}_resnet-filters{}-ksize{}-poolingstr{}-loopnum{}.mat'
...
if Is_Training == 1:
    ...
    np.savetxt('raw_1-200_Xval.csv', XvalCsv, delimiter=',')
    np.savetxt('raw_1-200_yval.csv', yval[0:200], delimiter=',')
...
matfile = scipy.io.loadmat('xval_testHAR-filters{}-poolingstr{}_resnet-filters{}-ksize{}-poolingstr{}-loopnum{}.mat'
                           .format(encoder_confilt, encoder_poolstr, convfilt, ksize, poolstr, loop))
...
# print(scores)
    ypred = model.predict(Xval[0:200])
    np.savetxt('raw_1-200_ypred.csv', ypred, delimiter=',')
    final_scores = []
    ...
    #     sco = np.append(sco, s, axis=0)
        ...
        sco = np.array([range(128 * 9)])
        sco = np.append(sco, scores, axis=0)
        np.savetxt('raw_1-200_final_scores_' + str(task_idx) + '.csv', sco, delimiter=',')
