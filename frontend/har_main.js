...
// d3.csv('./data/HAR/raw_1-200_HARUCI_yval.csv', function (res) {
//     console.log(res);
...
// })
d3.csv('./data/HAR/raw_1-200_HARUCI_Xval.csv', function (res) {
    console.log(res);
    var scale1 = 10,
        scale2 = 10;
    pushRecord2Array(res, 1, colors[0]);
    d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_0.csv', function (fs0) {
        pushRecord2Array(fs0, scale1, colors[1]);
        pushRecord2OneDArray(fs0, scale2, 0, colors[1]);
        d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_1.csv', function (fs1) {
            pushRecord2Array(fs1, scale1, colors[2]);
            pushRecord2OneDArray(fs1, scale2, 1, colors[2]);
            console.log(fs1);
            d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_2.csv', function (fs2) {
                pushRecord2Array(fs2, scale1, colors[3]);
                pushRecord2OneDArray(fs2, scale2, 2, colors[3]);
                console.log(fs2);
                d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_3.csv', function (fs3) {
                    pushRecord2Array(fs3, scale1, colors[4]);
                    pushRecord2OneDArray(fs3, scale2, 3, colors[4]);
                    console.log(fs3);
                    d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_4.csv', function (fs4) {
                        pushRecord2Array(fs4, scale1, colors[5]);
                        pushRecord2OneDArray(fs4, scale2, 4, colors[5]);
                        console.log(fs4);
                        d3.csv('./data/HAR/raw_1-200_HARUCI_final_scores_5.csv', function (fs5) {
